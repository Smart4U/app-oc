...
$router->get('pages.services', '/services', [PagesController::class, 'services'], 'services');
...
$router->get('contact.index-form', '/contact#contaxt-form', [ContactController::class, 'index']);
